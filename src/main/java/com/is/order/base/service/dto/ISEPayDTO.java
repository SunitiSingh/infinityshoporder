...
/**
 * A DTO for the ISEPay entity.
 */
public class ISEPayDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        ISEPayDTO iSEPayDTO = (ISEPayDTO) o;
        if (iSEPayDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), iSEPayDTO.getId());
    }
